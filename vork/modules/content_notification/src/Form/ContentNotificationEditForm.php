...
/**
 * Class ContentNotificationEditForm implements notification edit form.
 */
class ContentNotificationEditForm extends FormBase {
  ...
  public function getFormId() {
    return 'email_content_notification_edit_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $notification = NULL) {
    $form = [];
    $data = $this->contentNotificationService->getNotifications($notification);
    if (count($data)) {
      $data = reset($data);
    ...
    if ($this->contentNotificationService->isWorkflowEnabled()) {
      ...
      $form['content_notification_content_type']['content_notification_workflow_states']['content_notification_workflow_state'] = [
        ...
        '#default_value' => $data->data['content_notification_workflow_state'],
      ];
    }
    ...
    $form['content_notification_content_type']['content_notification_allowed_roles'] = [
      ...
      '#options' => $user_roles,
      '#default_value' => $data->data['content_notification_allowed_roles'],
    ...
    $form['content_notification_recepient_fieldset']['content_notification_email_limit'] = [
      ...
      '#default_value' => $data->data['content_notification_email_limit'],
    ...
    $form['content_notification_recepient_fieldset']['content_notification_email'] = [
      ...
      '#default_value' => $data->data['content_notification_email'],
    ];
    ...
    $form['content_notification_recepient_fieldset']['content_notification_roles_notified'] = [
      ...
      '#options' => $user_roles,
      '#default_value' => $data->data['content_notification_roles_notified'],
    ...
    $form['content_notification_email_fieldset']['content_notification_email_subject'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $data->data['content_notification_email_subject'],
    ...
    $form['content_notification_email_fieldset']['content_notification_email_body'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $data->data['content_notification_email_body'],
    ...
    if ($this->contentNotificationService->isTokenEnabled()) {
      ...
      $form['content_notification_email_fieldset']['token_tree'] = [
        ...
        '#token_types' => ['user', 'node', 'content-type', 'current-date', 'current-user'],
    ...
    $form['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Edit Notification'),
    ];
    return $form;
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    try {
      $this->contentNotificationService->upDateNotifications($fields, $user_input_values['notification_id']);
      \Drupal::logger('content_notification')->info($this->t('Email content notification has been updated successfully.'));
      \Drupal::messenger()->addMessage('Email content notification has been updated successfully.');
    }
    catch (Exception $e) {
